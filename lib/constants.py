SYSTEM_PROMPT_DATA_EXTRACT = """
    ...
    3. generate_report - Create comprehensive reports for emergency incidents based on structured data
    ...
    Format your output exactly according to the schema provided below, with no additional text outside the specified format.
"""